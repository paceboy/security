...
| checkTimeStart | String | N | 安检时间开始（yyyy-MM-dd HH:mm:ss） |
| checkTimeEnd | String | N | 安检时间结束（yyyy-MM-dd HH:mm:ss） |
...
```json
{
  ...
  "handleResult": "暂存",
  "checkTimeStart": "2025-11-01 00:00:00",
  "checkTimeEnd": "2025-11-25 23:59:59",
  "station": "T1航站楼"
}
```
...
# 示例1：基础查询（第1页，每页10条）
curl -X GET \
  "http://192.168.0.188:8080/security/record/list?pageNum=1&pageSize=10" \
...
# 示例2：按旅客姓名查询
curl -X GET \
  "http://192.168.0.188:8080/security/record/list?pageNum=1&pageSize=10&passengerName=旅客" \
  -H "Authorization: Bearer <your_token>"

# 示例3：查询开包记录
curl -X GET \
  "http://192.168.0.188:8080/security/record/list?pageNum=1&pageSize=10&isOpened=1" \
  -H "Authorization: Bearer <your_token>"

# 示例4：查询违禁品记录
curl -X GET \
  "http://192.168.0.188:8080/security/record/list?pageNum=1&pageSize=10&hasContraband=1" \
  -H "Authorization: Bearer <your_token>"

# 示例5：按时间范围查询
curl -X GET \
  "http://192.168.0.188:8080/security/record/list?pageNum=1&pageSize=10&beginTime=2025-12-09%2000:00:00&endTime=2025-12-09%2023:59:59" \
  -H "Authorization: Bearer <your_token>"

# 示例6：组合查询-今日所有违禁品记录
curl -X GET \
  "http://192.168.0.188:8080/security/record/list?hasContraband=1&beginTime=2025-12-09%2000:00:00&endTime=2025-12-09%2023:59:59" \
  -H "Authorization: Bearer <your_token>"
```
...
# 查询ID=1的安检记录详情
curl -X GET \
  "http://192.168.0.188:8080/security/record/1" \
  -H "Authorization: Bearer eyJhbGciOiJIUzUxMiJ9.eyJ1c2VyX2lkIjoxLCJ1c2VyX2tleSI6IjRhMTM1NjM2LTQ2MTgtNDdkMC1hODFkLWNlMWNiZmI3ODkyNiIsInVzZXJuYW1lIjoiYWRtaW4ifQ.UhW0rAU6iJpKl7nCpdbeme-ZTmgQu1I0ooP-3AbV7Vb9rMSNKjP9IGaeo3iiEnswOx-vc5385kr1d2eMM7OsnQ"
```
...
# 安检记录登记
curl -X POST \
  "http://192.168.0.188:9202/security/record/register" \
...
# 新增安检记录
curl -X POST \
  "http://192.168.0.188:9202/security/record" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer <your_token>" \
  -d '{
    "passengerName": "张三",
...
# 删除安检记录
curl -X POST \
  "http://192.168.0.188:9202/security/record/delete" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer <your_token>" \
  -d '{
    "ids": [1001, 1002, 1003]
...
# 导出安检记录
curl -X POST \
  "http://192.168.0.188:9202/security/record/export?checkStatus=1&checkTimeStart=2025-11-01%2000:00:00&checkTimeEnd=2025-11-25%2023:59:59" \
  -H "Authorization: Bearer <your_token>" \
  -o "安检记录.xlsx"
```
...
# 获取包裹统计数据
curl -X GET \
  "http://192.168.0.188:9202/security/record/packageStats" \
  -H "Authorization: Bearer <your_token>"
```
...
| preDisposal | String | N | 预处置方式：禁止携带、禁止携带可托运、限量携带 |
| handleResult | String | N | 最终处置方式：暂存、移交公安、快递、自弃、亲友带回、本人认领、非本人认领 |
...
| preDisposal | String | 预处置方式：禁止携带、禁止携带可托运、限量携带 |
| handleResult | String | 最终处置方式：暂存、移交公安、快递、自弃、亲友带回、本人认领、非本人认领 |
| passengerName | String | 旅客姓名 |
| idCard | String | 旅客身份证号（脱敏） |
| phone | String | 旅客手机号 |
| checkInStaffName | String | 值机人员姓名 |
...
# 示例1：基础查询（第1页，每页10条）
curl -X GET \
  "http://192.168.0.188:8080/security/contraband/list?pageNum=1&pageSize=10" \
  -H "Authorization: Bearer <your_token>"

# 示例2：按类别查询（查询易燃物品）
curl -X GET \
  "http://192.168.0.188:8080/security/contraband/list?pageNum=1&pageSize=10&category=易燃物品" \
  -H "Authorization: Bearer <your_token>"

# 示例3：按违禁品名称查询
curl -X GET \
  "http://192.168.0.188:8080/security/contraband/list?pageNum=1&pageSize=10&itemName=打火机" \
  -H "Authorization: Bearer <your_token>"

# 示例4：按手机号查询
curl -X GET \
  "http://192.168.0.188:8080/security/contraband/list?pageNum=1&pageSize=10&phone=138" \
  -H "Authorization: Bearer <your_token>"

# 示例5：组合查询（手机号 + 其他条件）
curl -X GET \
  "http://192.168.0.188:8080/security/contraband/list?pageNum=1&pageSize=10&phone=138&category=易燃物品" \
  -H "Authorization: Bearer <your_token>"
```
...
| preDisposal | String | 预处置方式 |
| handleResult | String | 处置方式 |
...
# 查询ID=1的违禁品详情
curl -X GET \
  "http://192.168.0.188:8080/security/contraband/1" \
  -H "Authorization: Bearer <your_token>"
```
...
**功能说明**: 处理违禁品，包括设置处置方式、认领信息、物流信息等

**请求参数**:
| 字段名 | 类型 | 必填 | 说明 |
|-------|------|-----|------|
| id | Long | Y | 违禁品ID |
| handleResult | String | Y | 处理结果：暂存、移交公安、快递、自弃、亲友带回、本人认领、非本人认领 |
| claimInfo | Object | N | 认领信息（当handleResult为本人认领或非本人认领时必填） |
| logisticsInfo | Object | N | 物流信息（当handleResult为快递时必填） |
| remark | String | N | 备注 |
...
# 获取违禁品类别列表（28个类别）
curl -X GET \
  "http://192.168.0.188:8080/security/contraband/categories" \
  -H "Authorization: Bearer <your_token>"
```
...
# 示例1：查询今天的统计数据（默认）
curl -X GET \
  "http://192.168.0.188:8080/security/statistics/overview" \
  -H "Authorization: Bearer <your_token>"

# 示例2：查询指定日期的统计数据
curl -X GET \
  "http://192.168.0.188:8080/security/statistics/overview?date=2025-12-09" \
  -H "Authorization: Bearer <your_token>"
```
...
curl -X GET \
  "http://192.168.0.188:8080/security/statistics/openTrend?dimension=today" \
  -H "Authorization: Bearer <your_token>"

# 示例2：本周趋势（按天统计，周一至周日）
curl -X GET \
  "http://192.168.0.188:8080/security/statistics/openTrend?dimension=thisWeek" \
  -H "Authorization: Bearer <your_token>"

# 示例3：本月趋势（按周统计，第1周、第2周...）
curl -X GET \
  "http://192.168.0.188:8080/security/statistics/openTrend?dimension=thisMonth" \
  -H "Authorization: Bearer <your_token>"
```
...
curl -X GET \
  "http://192.168.0.188:8080/security/statistics/contrabandTrend?dimension=today" \
  -H "Authorization: Bearer <your_token>"

# 示例2：本周违禁品趋势（按天统计，周一至周日）
curl -X GET \
  "http://192.168.0.188:8080/security/statistics/contrabandTrend?dimension=thisWeek" \
  -H "Authorization: Bearer <your_token>"

# 示例3：本月违禁品趋势（按周统计，第1周、第2周...）
curl -X GET \
  "http://192.168.0.188:8080/security/statistics/contrabandTrend?dimension=thisMonth" \
  -H "Authorization: Bearer <your_token>"
```
...
| email | String | N | 邮箱 |
| faceImageUrl | String | Y | 人脸图片URL（通过人脸采集接口获取） |
| faceFeature | String | Y | 人脸特征数据（通过人脸采集接口获取） |
...
2. 确认后执行逻辑删除，设置del_flag=2
3. 不能删除admin用户（user_id=1）
...
**业务规则**:
1. 点击重置密码按钮，弹出二次确认：确认重置该用户密码为123456？
2. 确认后将密码重置为123456（BCrypt加密）
3. 更新sys_user表的password字段
4. 更新pwd_update_date为当前时间
...
# 分页查询角色列表
curl -X GET \
  "http://192.168.0.188:9201/system/role/list?pageNum=1&pageSize=10&roleName=管理" \
  -H "Authorization: Bearer <your_token>"
```
...
| roleKey | String | Y | 角色权限字符串 |
| roleSort | Integer | Y | 显示顺序 |
| status | String | N | 状态（0正常 1停用），默认0 |
...
# 新增角色
curl -X POST \
  "http://192.168.0.188:9201/system/role" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer <your_token>" \
  -d '{
    "roleName": "财务人员",
...
# 编辑角色
curl -X POST \
  "http://192.168.0.188:9201/system/role/update" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer <your_token>" \
  -d '{
    "roleId": 4,
...
# 删除角色
curl -X DELETE \
  "http://192.168.0.188:9201/system/role/4" \
  -H "Authorization: Bearer <your_token>"
```
...
# 查询部门树列表
curl -X GET \
  "http://192.168.0.188:9201/system/dept/treeList" \
  -H "Authorization: Bearer <your_token>"
```
...
# 新增部门（顶级部门）
curl -X POST \
  "http://192.168.0.188:9201/system/dept" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer <your_token>" \
  -d '{
    "parentId": 0,
...
# 编辑部门
curl -X POST \
  "http://192.168.0.188:9201/system/dept/update" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer <your_token>" \
  -d '{
    "deptId": 103,
...
# 删除部门
curl -X DELETE \
  "http://192.168.0.188:9201/system/dept/103" \
  -H "Authorization: Bearer <your_token>"
```
...
# 批量删除部门
curl -X POST \
  "http://192.168.0.188:9201/system/dept/deleteBatch" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer <your_token>" \
  -d '{
    "deptIds": [103, 104, 105]
...
# 获取菜单列表
curl -X GET \
  "http://192.168.0.188:9201/system/menu/list?menuName=系统&status=0" \
  -H "Authorization: Bearer <your_token>"
```
...
# 获取菜单详细信息
curl -X GET \
  "http://192.168.0.188:9201/system/menu/1" \
  -H "Authorization: Bearer <your_token>"
```
...
# 获取菜单下拉树列表
curl -X GET \
  "http://192.168.0.188:9201/system/menu/treeselect?status=0" \
  -H "Authorization: Bearer <your_token>"
```
...
# 加载角色菜单列表树
curl -X GET \
  "http://192.168.0.188:9201/system/menu/roleMenuTreeselect/1" \
  -H "Authorization: Bearer <your_token>"
```
...
# 获取路由信息
curl -X GET \
  "http://192.168.0.188:9201/system/menu/getRouters" \
  -H "Authorization: Bearer <your_token>"
```
...
# 新增菜单
curl -X POST \
  "http://192.168.0.188:9201/system/menu" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer <your_token>" \
  -d '{
    "menuName": "用户管理",
...
# 删除菜单
curl -X DELETE \
  "http://192.168.0.188:9201/system/menu/100" \
  -H "Authorization: Bearer <your_token>"
```
